...
export function SettingsScreen() {
  ...
  return (
    <Screen>
      ...
      <Card><h2>実行環境の状態</h2><dl className="status-list"><div><dt>Codex App Server</dt><dd className="warning">初回生成時に確認</dd></div><div><dt>SuperCollider</dt><dd className="warning">互換性確認が必要</dd></div><div><dt>保存先</dt><dd className="accent">ローカル SQLite</dd></div></dl></Card>
      ...
      <Card><h2>MVPの制約</h2><p>外部サンプル、マイク、Quarks、追加UGen、自由プロンプト、SCコード編集、クラウド同期は無効です。</p></Card>
    </Screen>
  );
}
