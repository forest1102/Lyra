...
const EXPECTED_WEBCHUCK_SHA256 = {
...
export function assertWebChuckRuntimeAssets(directory = WEBCHUCK_SOURCE_DIRECTORY): void {
  for (const [filename, expected] of Object.entries(EXPECTED_WEBCHUCK_SHA256)) {
...
export default defineConfig({
  plugins: [
    ...
    ...viteStaticCopy({
      targets: [
        {
          src: Object.keys(EXPECTED_WEBCHUCK_SHA256).map((filename) =>
